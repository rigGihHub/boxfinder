...
export default async function ProductPage({ params }) {
  ...
  return <main className="productPage">
    <header className="productNav"><a className="brand" href="/"><span className="brandMark">BF</span><span>BOXFINDER<small>CHASE SMARTER</small></span></a><a className="backLink" href="/">← TILL TOPPLISTAN</a><span className="version">v0.39.1</span></header>
    ...
    <section className="chaseSection"><div className="sectionHead"><div><span className="kicker">CHASE BOARD</span><h2>Viktigaste korten vi har data på</h2></div><p>{p.checklist?.card_count || 0} kort i checklistan · {p.checklist?.verification_status || 'ingen verifiering'}</p></div>
