...
export default async function ProductPage({ params }) {
  ...
  return <main className="productPage">
    <header className="productNav"><a className="brand" href="/"><span className="brandMark">BF</span><span>BOXFINDER<small>CHASE SMARTER</small></span></a><a className="backLink" href="/">← TILL TOPPLISTAN</a><span className="version">v0.46.1</span></header>
