SOURCE_PROFILES = {
    ...
    "Bangerpack": {"priority":1,"coverage":["Fotboll","F1","Pokémon","One Piece","Marvel","Amerikansk sport"],"strength":"Brett sealed-sortiment över sport, TCG och entertainment","recommended_ingest":"CSV/feed först; HTML efter policygranskning"},
    ...
    "Aquitaz": {"priority":1,"coverage":["Pokémon","One Piece","Magic","Lorcana","Star Wars Unlimited"],"strength":"Stort sealed-sortiment med många box- och caseformat","recommended_ingest":"Feed/CSV eller manuell import tills policy är granskad"},
    ...
    "Kantovault": {"priority":2,"coverage":["Pokémon","One Piece"],"strength":"Direkta artikelsidor för japanska sealed-produkter med tydlig lagerstatus","recommended_ingest":"Manuell verifiering eller feed/API; HTML först efter policygranskning"},
